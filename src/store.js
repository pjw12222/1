...
const mutations = {
  ...
  savaAllMsg(state, all) {
    state.baseMsg = all.baseMsg;
    state.skillMsg = all.skillMsg;
    state.educationMsg = all.educationMsg;
    state.internMsg = all.internMsg;
    state.projectMsg = all.projectMsg;
  }
};
